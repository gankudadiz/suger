...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection blog_id
     ...
     * @method Grid\Column|Collection blog_id(string $label = null)
     ...
     * @property Show\Field|Collection blog_id
     ...
     * @method Show\Field|Collection blog_id(string $label = null)
